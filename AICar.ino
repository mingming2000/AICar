...
void loop() {
  ...
  if(modeState == 1) {       
    ...
    pedalVal = map(pedalVal, 180, 870, 0, 250);
    pedalVal = constrain(pedalVal, 0, 250);
...
//    cmd = Serial.read(); //수동모드일 경우, if(Serial3.available()) 주석처리 후, Seral.read() 사용
